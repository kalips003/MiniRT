...
int	distance_from_arrow(t_c_px *calcul, void *obj, int simple)
{
	...
	arrow = (t_arrow *)obj;
	c.cy = (t_cylinder){CYLINDER, arrow->O, arrow->param, arrow->xyz_other, arrow->h * 2 / 3, arrow->radius / 2};
	c.co = (t_cone){CONE, arrow->O, arrow->param, arrow->h / 3, arrow->radius, arrow->apex, arrow->slope, 0};
