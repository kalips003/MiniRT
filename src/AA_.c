...
///////////////////////////////////////////////////////////////////////////////]
int	h_set_arrow(t_arrow *arrow, t_coor o, t_vect v, t_rgb c);
...
void	h_render_v_space(t_data *data, t_c_px *calcul)
{
	...
	h_set_arrow(&arrow_x, calcul->object->O.c0, calcul->object->O.right, (t_rgb){255,0,0});
	h_set_arrow(&arrow_y, calcul->object->O.c0, calcul->object->O.up, (t_rgb){0,255,0});
	h_set_arrow(&arrow_z, calcul->object->O.c0, calcul->object->O.view, (t_rgb){0,0,255});
