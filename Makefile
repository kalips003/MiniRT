...
define rules
	...
	@printf "\033[1;36mMovement\033[0m\n"
	@printf "  • Arrow keys\n"
	@printf "  • Home (up) / End (down)\n\n"

	@printf "\033[1;36mRotation\033[0m\n"
	@printf "  • W A S D + Q E\n\n"

	@printf "\033[1;36mMouse\033[0m\n"
	@printf "  • Right click → select object\n"
	@printf "  • Left click + drag → move camera\n"
	@printf "  • Left click + drag (while item is selected) → move selected object\n"
	@printf "  • Right click again → unselect\n"
	@printf "  • Mouse wheel → adjust movement speed\n\n"

	@printf "\033[1;36mObject Control\033[0m\n"
